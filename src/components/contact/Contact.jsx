...
const Contact = () => {
  return (
    <div>
      <h1 className='flex items-center text-[3.25rem] font-mark__pro tracking-tight'>
        <span
      ...
      <h2 className=' text-4xl leading-[3.5rem] tracking-tighter text-[#c4c4c4] font-medium mt-12'>
