...
const Socials = () => {
  return (
    <div>
      ...
      <p className='mb-12 mt-2 text-xs ml-1 sm:text-base text-gray-100'>
        Connect with me online
      </p>
      <div className=' flex justify-between items-center gap-3 sm:gap-6 flex-wrap max-w-lg'>
        <a
          href='https://github.com/Shriom-Trivedi'
          target='_blank'
          rel='noreferrer'
          className='flex justify-between items-center text-[#c4c4c4] no-underline font-d__din__Condensed uppercase leading-[90%] tracking-tight text-lg sm:text-xl font-thin ease-in-out'
        >
          👾 GitHub
        </a>
        <a
